...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex flex-col">
      ...
      <div className="flex-1 bg-dcss-dark flex items-center justify-center py-12">
      ...
      <div 
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(38, 70, 83, 0.3), rgba(38, 70, 83, 0.3)), url(${heroImagePath})`,
